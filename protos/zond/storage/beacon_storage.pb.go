...
type StorageBeaconStateV1 struct {
	...
	Version          Version `protobuf:"varint,1001,opt,name=version,proto3,enum=zond.eth.storage.Version" json:"version,omitempty"`
...
var file_proto_prysm_storage_beacon_storage_proto_goTypes = []interface{}{
	(*BeaconStateForStorage)(nil), // 0: zond.eth.storage.BeaconStateForStorage
	(*StorageBeaconStateV1)(nil),  // 1: zond.eth.storage.StorageBeaconStateV1
	(Version)(0),                  // 2: zond.eth.storage.Version
}
var file_proto_prysm_storage_beacon_storage_proto_depIdxs = []int32{
	1, // 0: zond.eth.storage.BeaconStateForStorage.state_v1:type_name -> zond.eth.storage.StorageBeaconStateV1
	2, // 1: zond.eth.storage.StorageBeaconStateV1.version:type_name -> zond.eth.storage.Version
