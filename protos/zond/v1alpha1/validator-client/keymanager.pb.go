...
type SignRequest struct {
	...
	SigningSlot github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot `protobuf:"varint,6,opt,name=signing_slot,json=signingSlot,proto3" json:"signing_slot,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
}
...
func (x *SignRequest) GetSlot() github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot {
...
func (x *SignRequest) GetEpoch() github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch {
...
type SignRequest_Slot struct {
	Slot github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot `protobuf:"varint,105,opt,name=slot,proto3,oneof" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
}

type SignRequest_Epoch struct {
	Epoch github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch `protobuf:"varint,106,opt,name=epoch,proto3,oneof" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Epoch"`
}
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_goTypes = []interface{}{
	...
	(*v1alpha1.BeaconBlock)(nil),                  // 4: zond.eth.v1alpha1.BeaconBlock
	(*v1alpha1.AttestationData)(nil),              // 5: zond.eth.v1alpha1.AttestationData
	(*v1alpha1.AggregateAttestationAndProof)(nil), // 6: zond.eth.v1alpha1.AggregateAttestationAndProof
	(*v1alpha1.VoluntaryExit)(nil),                // 7: zond.eth.v1alpha1.VoluntaryExit
	(*v1alpha1.BeaconBlockAltair)(nil),            // 8: zond.eth.v1alpha1.BeaconBlockAltair
	(*v1alpha1.SyncAggregatorSelectionData)(nil),  // 9: zond.eth.v1alpha1.SyncAggregatorSelectionData
	(*v1alpha1.ContributionAndProof)(nil),         // 10: zond.eth.v1alpha1.ContributionAndProof
	(*v1alpha1.BeaconBlockBellatrix)(nil),         // 11: zond.eth.v1alpha1.BeaconBlockBellatrix
	(*v1alpha1.BlindedBeaconBlockBellatrix)(nil),  // 12: zond.eth.v1alpha1.BlindedBeaconBlockBellatrix
	(*v1alpha1.ValidatorRegistrationV1)(nil),      // 13: zond.eth.v1alpha1.ValidatorRegistrationV1
	(*empty.Empty)(nil),                           // 14: google.protobuf.Empty
}
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_depIdxs = []int32{
	4,  // 0: ethereum.validator.accounts.v2.SignRequest.block:type_name -> zond.eth.v1alpha1.BeaconBlock
	5,  // 1: ethereum.validator.accounts.v2.SignRequest.attestation_data:type_name -> zond.eth.v1alpha1.AttestationData
	6,  // 2: ethereum.validator.accounts.v2.SignRequest.aggregate_attestation_and_proof:type_name -> zond.eth.v1alpha1.AggregateAttestationAndProof
	7,  // 3: ethereum.validator.accounts.v2.SignRequest.exit:type_name -> zond.eth.v1alpha1.VoluntaryExit
	8,  // 4: ethereum.validator.accounts.v2.SignRequest.block_altair:type_name -> zond.eth.v1alpha1.BeaconBlockAltair
	9,  // 5: ethereum.validator.accounts.v2.SignRequest.sync_aggregator_selection_data:type_name -> zond.eth.v1alpha1.SyncAggregatorSelectionData
	10, // 6: ethereum.validator.accounts.v2.SignRequest.contribution_and_proof:type_name -> zond.eth.v1alpha1.ContributionAndProof
	11, // 7: ethereum.validator.accounts.v2.SignRequest.block_bellatrix:type_name -> zond.eth.v1alpha1.BeaconBlockBellatrix
	12, // 8: ethereum.validator.accounts.v2.SignRequest.blinded_block_bellatrix:type_name -> zond.eth.v1alpha1.BlindedBeaconBlockBellatrix
	13, // 9: ethereum.validator.accounts.v2.SignRequest.registration:type_name -> zond.eth.v1alpha1.ValidatorRegistrationV1
