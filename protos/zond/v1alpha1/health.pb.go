...
var file_proto_prysm_v1alpha1_health_proto_goTypes = []interface{}{
	(*LogsResponse)(nil), // 0: zond.eth.v1alpha1.LogsResponse
	(*empty.Empty)(nil),  // 1: google.protobuf.Empty
}
var file_proto_prysm_v1alpha1_health_proto_depIdxs = []int32{
	1, // 0: zond.eth.v1alpha1.Health.StreamBeaconLogs:input_type -> google.protobuf.Empty
	0, // 1: zond.eth.v1alpha1.Health.StreamBeaconLogs:output_type -> zond.eth.v1alpha1.LogsResponse
...
func (c *healthClient) StreamBeaconLogs(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Health_StreamBeaconLogsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Health_serviceDesc.Streams[0], "/zond.eth.v1alpha1.Health/StreamBeaconLogs", opts...)
	if err != nil {
		return nil, err
	}
...
var _Health_serviceDesc = grpc.ServiceDesc{
	ServiceName: "zond.eth.v1alpha1.Health",
