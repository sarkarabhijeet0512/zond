...
// 	protoc        v3.15.8
// source: protos/zond/v1alpha1/attestation.proto
...
func (x *AttestationData) GetCommitteeIndex() github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.CommitteeIndex {
	if x != nil {
...
var file_proto_prysm_v1alpha1_attestation_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x38, 0x92, 0xb5, 0x18, 0x04, 0x32, 0x30, 0x34, 0x38,
	0x82, 0xb5, 0x18, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70,
	0x72, 0x79, 0x73, 0x6d, 0x61, 0x74, 0x69, 0x63, 0x6c, 0x61, 0x62, 0x73, 0x2f, 0x67, 0x6f, 0x2d,
	0x62, 0x69, 0x74, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x2e, 0x42, 0x69, 0x74, 0x6c, 0x69, 0x73, 0x74,
...
var file_proto_prysm_v1alpha1_attestation_proto_goTypes = []interface{}{
	(*Attestation)(nil),                        // 0: zond.eth.v1alpha1.Attestation
	(*AggregateAttestationAndProof)(nil),       // 1: zond.eth.v1alpha1.AggregateAttestationAndProof
	(*SignedAggregateAttestationAndProof)(nil), // 2: zond.eth.v1alpha1.SignedAggregateAttestationAndProof
	(*AttestationData)(nil),                    // 3: zond.eth.v1alpha1.AttestationData
	(*Checkpoint)(nil),                         // 4: zond.eth.v1alpha1.Checkpoint
}
var file_proto_prysm_v1alpha1_attestation_proto_depIdxs = []int32{
	3, // 0: zond.eth.v1alpha1.Attestation.data:type_name -> zond.eth.v1alpha1.AttestationData
	0, // 1: zond.eth.v1alpha1.AggregateAttestationAndProof.aggregate:type_name -> zond.eth.v1alpha1.Attestation
	1, // 2: zond.eth.v1alpha1.SignedAggregateAttestationAndProof.message:type_name -> zond.eth.v1alpha1.AggregateAttestationAndProof
	4, // 3: zond.eth.v1alpha1.AttestationData.source:type_name -> zond.eth.v1alpha1.Checkpoint
	4, // 4: zond.eth.v1alpha1.AttestationData.target:type_name -> zond.eth.v1alpha1.Checkpoint
