...
// 	protoc        v3.15.8
// source: protos/zond/v1alpha1/p2p_messages.proto
...
type Status struct {
	...
	FinalizedEpoch github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch `protobuf:"varint,3,opt,name=finalized_epoch,json=finalizedEpoch,proto3" json:"finalized_epoch,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Epoch"`
	HeadRoot       []byte                                                             `protobuf:"bytes,4,opt,name=head_root,json=headRoot,proto3" json:"head_root,omitempty" ssz-size:"32"`
	HeadSlot       github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot  `protobuf:"varint,5,opt,name=head_slot,json=headSlot,proto3" json:"head_slot,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
}
...
type BeaconBlocksByRangeRequest struct {
	...
	StartSlot github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot `protobuf:"varint,1,opt,name=start_slot,json=startSlot,proto3" json:"start_slot,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
...
type ENRForkID struct {
	...
	NextForkEpoch     github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch `protobuf:"varint,3,opt,name=next_fork_epoch,json=nextForkEpoch,proto3" json:"next_fork_epoch,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Epoch"`
}
...
var file_proto_prysm_v1alpha1_p2p_messages_proto_goTypes = []interface{}{
	(*Status)(nil),                     // 0: zond.eth.v1alpha1.Status
	(*BeaconBlocksByRangeRequest)(nil), // 1: zond.eth.v1alpha1.BeaconBlocksByRangeRequest
	(*ENRForkID)(nil),                  // 2: zond.eth.v1alpha1.ENRForkID
	(*MetaDataV0)(nil),                 // 3: zond.eth.v1alpha1.MetaDataV0
	(*MetaDataV1)(nil),                 // 4: zond.eth.v1alpha1.MetaDataV1
}
