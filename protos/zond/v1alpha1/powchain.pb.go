...
// 	protoc        v3.15.8
// source: protos/zond/v1alpha1/powchain.proto
...
var file_proto_prysm_v1alpha1_powchain_proto_goTypes = []interface{}{
	(*ETH1ChainData)(nil),    // 0: zond.eth.v1alpha1.ETH1ChainData
	(*LatestETH1Data)(nil),   // 1: zond.eth.v1alpha1.LatestETH1Data
	(*ChainStartData)(nil),   // 2: zond.eth.v1alpha1.ChainStartData
	(*SparseMerkleTrie)(nil), // 3: zond.eth.v1alpha1.SparseMerkleTrie
	(*TrieLayer)(nil),        // 4: zond.eth.v1alpha1.TrieLayer
	(*DepositContainer)(nil), // 5: zond.eth.v1alpha1.DepositContainer
	(*BeaconState)(nil),      // 6: zond.eth.v1alpha1.BeaconState
	(*Eth1Data)(nil),         // 7: zond.eth.v1alpha1.Eth1Data
	(*Deposit)(nil),          // 8: zond.eth.v1alpha1.Deposit
}
var file_proto_prysm_v1alpha1_powchain_proto_depIdxs = []int32{
	1, // 0: zond.eth.v1alpha1.ETH1ChainData.current_eth1_data:type_name -> zond.eth.v1alpha1.LatestETH1Data
	2, // 1: zond.eth.v1alpha1.ETH1ChainData.chainstart_data:type_name -> zond.eth.v1alpha1.ChainStartData
	6, // 2: zond.eth.v1alpha1.ETH1ChainData.beacon_state:type_name -> zond.eth.v1alpha1.BeaconState
	3, // 3: zond.eth.v1alpha1.ETH1ChainData.trie:type_name -> zond.eth.v1alpha1.SparseMerkleTrie
	5, // 4: zond.eth.v1alpha1.ETH1ChainData.deposit_containers:type_name -> zond.eth.v1alpha1.DepositContainer
	7, // 5: zond.eth.v1alpha1.ChainStartData.eth1_data:type_name -> zond.eth.v1alpha1.Eth1Data
	8, // 6: zond.eth.v1alpha1.ChainStartData.chainstart_deposits:type_name -> zond.eth.v1alpha1.Deposit
	4, // 7: zond.eth.v1alpha1.SparseMerkleTrie.layers:type_name -> zond.eth.v1alpha1.TrieLayer
	8, // 8: zond.eth.v1alpha1.DepositContainer.deposit:type_name -> zond.eth.v1alpha1.Deposit
