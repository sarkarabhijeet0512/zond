...
// 	protoc        v3.15.8
// source: protos/zond/v1alpha1/beacon_block.proto
...
type BeaconBlock struct {
	...
	ProposerIndex github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex `protobuf:"varint,2,opt,name=proposer_index,json=proposerIndex,proto3" json:"proposer_index,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.ValidatorIndex"`
...
var file_proto_prysm_v1alpha1_beacon_block_proto_goTypes = []interface{}{
	(*GenericSignedBeaconBlock)(nil),          // 0: zond.eth.v1alpha1.GenericSignedBeaconBlock
	(*GenericBeaconBlock)(nil),                // 1: zond.eth.v1alpha1.GenericBeaconBlock
	(*BeaconBlock)(nil),                       // 2: zond.eth.v1alpha1.BeaconBlock
	(*SignedBeaconBlock)(nil),                 // 3: zond.eth.v1alpha1.SignedBeaconBlock
	(*BeaconBlockAltair)(nil),                 // 4: zond.eth.v1alpha1.BeaconBlockAltair
	(*SignedBeaconBlockAltair)(nil),           // 5: zond.eth.v1alpha1.SignedBeaconBlockAltair
	(*BeaconBlockBody)(nil),                   // 6: zond.eth.v1alpha1.BeaconBlockBody
	(*BeaconBlockBodyAltair)(nil),             // 7: zond.eth.v1alpha1.BeaconBlockBodyAltair
	(*ProposerSlashing)(nil),                  // 8: zond.eth.v1alpha1.ProposerSlashing
	(*AttesterSlashing)(nil),                  // 9: zond.eth.v1alpha1.AttesterSlashing
	(*Deposit)(nil),                           // 10: zond.eth.v1alpha1.Deposit
	(*VoluntaryExit)(nil),                     // 11: zond.eth.v1alpha1.VoluntaryExit
	(*SignedVoluntaryExit)(nil),               // 12: zond.eth.v1alpha1.SignedVoluntaryExit
	(*Eth1Data)(nil),                          // 13: zond.eth.v1alpha1.Eth1Data
	(*BeaconBlockHeader)(nil),                 // 14: zond.eth.v1alpha1.BeaconBlockHeader
	(*SignedBeaconBlockHeader)(nil),           // 15: zond.eth.v1alpha1.SignedBeaconBlockHeader
	(*IndexedAttestation)(nil),                // 16: zond.eth.v1alpha1.IndexedAttestation
	(*SyncAggregate)(nil),                     // 17: zond.eth.v1alpha1.SyncAggregate
	(*SignedBeaconBlockBellatrix)(nil),        // 18: zond.eth.v1alpha1.SignedBeaconBlockBellatrix
	(*BeaconBlockBellatrix)(nil),              // 19: zond.eth.v1alpha1.BeaconBlockBellatrix
	(*BeaconBlockBodyBellatrix)(nil),          // 20: zond.eth.v1alpha1.BeaconBlockBodyBellatrix
	(*SignedBlindedBeaconBlockBellatrix)(nil), // 21: zond.eth.v1alpha1.SignedBlindedBeaconBlockBellatrix
	(*BlindedBeaconBlockBellatrix)(nil),       // 22: zond.eth.v1alpha1.BlindedBeaconBlockBellatrix
	(*BlindedBeaconBlockBodyBellatrix)(nil),   // 23: zond.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix
	(*SignedBeaconBlockCapella)(nil),          // 24: zond.eth.v1alpha1.SignedBeaconBlockCapella
	(*BeaconBlockCapella)(nil),                // 25: zond.eth.v1alpha1.BeaconBlockCapella
	(*BeaconBlockBodyCapella)(nil),            // 26: zond.eth.v1alpha1.BeaconBlockBodyCapella
	(*SignedBlindedBeaconBlockCapella)(nil),   // 27: zond.eth.v1alpha1.SignedBlindedBeaconBlockCapella
	(*BlindedBeaconBlockCapella)(nil),         // 28: zond.eth.v1alpha1.BlindedBeaconBlockCapella
	(*BlindedBeaconBlockBodyCapella)(nil),     // 29: zond.eth.v1alpha1.BlindedBeaconBlockBodyCapella
	(*ValidatorRegistrationV1)(nil),           // 30: zond.eth.v1alpha1.ValidatorRegistrationV1
	(*SignedValidatorRegistrationsV1)(nil),    // 31: zond.eth.v1alpha1.SignedValidatorRegistrationsV1
	(*SignedValidatorRegistrationV1)(nil),     // 32: zond.eth.v1alpha1.SignedValidatorRegistrationV1
	(*BuilderBid)(nil),                        // 33: zond.eth.v1alpha1.BuilderBid
	(*SignedBuilderBid)(nil),                  // 34: zond.eth.v1alpha1.SignedBuilderBid
	(*Deposit_Data)(nil),                      // 35: zond.eth.v1alpha1.Deposit.Data
	(*Attestation)(nil),                       // 36: zond.eth.v1alpha1.Attestation
	(*AttestationData)(nil),                   // 37: zond.eth.v1alpha1.AttestationData
	...
	(*SignedBLSToExecutionChange)(nil),        // 41: zond.eth.v1alpha1.SignedBLSToExecutionChange
...
var file_proto_prysm_v1alpha1_beacon_block_proto_depIdxs = []int32{
	3,  // 0: zond.eth.v1alpha1.GenericSignedBeaconBlock.phase0:type_name -> zond.eth.v1alpha1.SignedBeaconBlock
	5,  // 1: zond.eth.v1alpha1.GenericSignedBeaconBlock.altair:type_name -> zond.eth.v1alpha1.SignedBeaconBlockAltair
	18, // 2: zond.eth.v1alpha1.GenericSignedBeaconBlock.bellatrix:type_name -> zond.eth.v1alpha1.SignedBeaconBlockBellatrix
	21, // 3: zond.eth.v1alpha1.GenericSignedBeaconBlock.blinded_bellatrix:type_name -> zond.eth.v1alpha1.SignedBlindedBeaconBlockBellatrix
	24, // 4: zond.eth.v1alpha1.GenericSignedBeaconBlock.capella:type_name -> zond.eth.v1alpha1.SignedBeaconBlockCapella
	27, // 5: zond.eth.v1alpha1.GenericSignedBeaconBlock.blinded_capella:type_name -> zond.eth.v1alpha1.SignedBlindedBeaconBlockCapella
	2,  // 6: zond.eth.v1alpha1.GenericBeaconBlock.phase0:type_name -> zond.eth.v1alpha1.BeaconBlock
	4,  // 7: zond.eth.v1alpha1.GenericBeaconBlock.altair:type_name -> zond.eth.v1alpha1.BeaconBlockAltair
	19, // 8: zond.eth.v1alpha1.GenericBeaconBlock.bellatrix:type_name -> zond.eth.v1alpha1.BeaconBlockBellatrix
	22, // 9: zond.eth.v1alpha1.GenericBeaconBlock.blinded_bellatrix:type_name -> zond.eth.v1alpha1.BlindedBeaconBlockBellatrix
	25, // 10: zond.eth.v1alpha1.GenericBeaconBlock.capella:type_name -> zond.eth.v1alpha1.BeaconBlockCapella
	28, // 11: zond.eth.v1alpha1.GenericBeaconBlock.blinded_capella:type_name -> zond.eth.v1alpha1.BlindedBeaconBlockCapella
	6,  // 12: zond.eth.v1alpha1.BeaconBlock.body:type_name -> zond.eth.v1alpha1.BeaconBlockBody
	2,  // 13: zond.eth.v1alpha1.SignedBeaconBlock.block:type_name -> zond.eth.v1alpha1.BeaconBlock
	7,  // 14: zond.eth.v1alpha1.BeaconBlockAltair.body:type_name -> zond.eth.v1alpha1.BeaconBlockBodyAltair
	4,  // 15: zond.eth.v1alpha1.SignedBeaconBlockAltair.block:type_name -> zond.eth.v1alpha1.BeaconBlockAltair
	13, // 16: zond.eth.v1alpha1.BeaconBlockBody.eth1_data:type_name -> zond.eth.v1alpha1.Eth1Data
	8,  // 17: zond.eth.v1alpha1.BeaconBlockBody.proposer_slashings:type_name -> zond.eth.v1alpha1.ProposerSlashing
	9,  // 18: zond.eth.v1alpha1.BeaconBlockBody.attester_slashings:type_name -> zond.eth.v1alpha1.AttesterSlashing
	36, // 19: zond.eth.v1alpha1.BeaconBlockBody.attestations:type_name -> zond.eth.v1alpha1.Attestation
	10, // 20: zond.eth.v1alpha1.BeaconBlockBody.deposits:type_name -> zond.eth.v1alpha1.Deposit
	12, // 21: zond.eth.v1alpha1.BeaconBlockBody.voluntary_exits:type_name -> zond.eth.v1alpha1.SignedVoluntaryExit
	13, // 22: zond.eth.v1alpha1.BeaconBlockBodyAltair.eth1_data:type_name -> zond.eth.v1alpha1.Eth1Data
	8,  // 23: zond.eth.v1alpha1.BeaconBlockBodyAltair.proposer_slashings:type_name -> zond.eth.v1alpha1.ProposerSlashing
	9,  // 24: zond.eth.v1alpha1.BeaconBlockBodyAltair.attester_slashings:type_name -> zond.eth.v1alpha1.AttesterSlashing
	36, // 25: zond.eth.v1alpha1.BeaconBlockBodyAltair.attestations:type_name -> zond.eth.v1alpha1.Attestation
	10, // 26: zond.eth.v1alpha1.BeaconBlockBodyAltair.deposits:type_name -> zond.eth.v1alpha1.Deposit
	12, // 27: zond.eth.v1alpha1.BeaconBlockBodyAltair.voluntary_exits:type_name -> zond.eth.v1alpha1.SignedVoluntaryExit
	17, // 28: zond.eth.v1alpha1.BeaconBlockBodyAltair.sync_aggregate:type_name -> zond.eth.v1alpha1.SyncAggregate
	15, // 29: zond.eth.v1alpha1.ProposerSlashing.header_1:type_name -> zond.eth.v1alpha1.SignedBeaconBlockHeader
	15, // 30: zond.eth.v1alpha1.ProposerSlashing.header_2:type_name -> zond.eth.v1alpha1.SignedBeaconBlockHeader
	16, // 31: zond.eth.v1alpha1.AttesterSlashing.attestation_1:type_name -> zond.eth.v1alpha1.IndexedAttestation
	16, // 32: zond.eth.v1alpha1.AttesterSlashing.attestation_2:type_name -> zond.eth.v1alpha1.IndexedAttestation
	35, // 33: zond.eth.v1alpha1.Deposit.data:type_name -> zond.eth.v1alpha1.Deposit.Data
	11, // 34: zond.eth.v1alpha1.SignedVoluntaryExit.exit:type_name -> zond.eth.v1alpha1.VoluntaryExit
	14, // 35: zond.eth.v1alpha1.SignedBeaconBlockHeader.header:type_name -> zond.eth.v1alpha1.BeaconBlockHeader
	37, // 36: zond.eth.v1alpha1.IndexedAttestation.data:type_name -> zond.eth.v1alpha1.AttestationData
	19, // 37: zond.eth.v1alpha1.SignedBeaconBlockBellatrix.block:type_name -> zond.eth.v1alpha1.BeaconBlockBellatrix
	20, // 38: zond.eth.v1alpha1.BeaconBlockBellatrix.body:type_name -> zond.eth.v1alpha1.BeaconBlockBodyBellatrix
	13, // 39: zond.eth.v1alpha1.BeaconBlockBodyBellatrix.eth1_data:type_name -> zond.eth.v1alpha1.Eth1Data
	8,  // 40: zond.eth.v1alpha1.BeaconBlockBodyBellatrix.proposer_slashings:type_name -> zond.eth.v1alpha1.ProposerSlashing
	9,  // 41: zond.eth.v1alpha1.BeaconBlockBodyBellatrix.attester_slashings:type_name -> zond.eth.v1alpha1.AttesterSlashing
	36, // 42: zond.eth.v1alpha1.BeaconBlockBodyBellatrix.attestations:type_name -> zond.eth.v1alpha1.Attestation
	10, // 43: zond.eth.v1alpha1.BeaconBlockBodyBellatrix.deposits:type_name -> zond.eth.v1alpha1.Deposit
	12, // 44: zond.eth.v1alpha1.BeaconBlockBodyBellatrix.voluntary_exits:type_name -> zond.eth.v1alpha1.SignedVoluntaryExit
	17, // 45: zond.eth.v1alpha1.BeaconBlockBodyBellatrix.sync_aggregate:type_name -> zond.eth.v1alpha1.SyncAggregate
	38, // 46: zond.eth.v1alpha1.BeaconBlockBodyBellatrix.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayload
	22, // 47: zond.eth.v1alpha1.SignedBlindedBeaconBlockBellatrix.block:type_name -> zond.eth.v1alpha1.BlindedBeaconBlockBellatrix
	23, // 48: zond.eth.v1alpha1.BlindedBeaconBlockBellatrix.body:type_name -> zond.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix
	13, // 49: zond.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.eth1_data:type_name -> zond.eth.v1alpha1.Eth1Data
	8,  // 50: zond.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.proposer_slashings:type_name -> zond.eth.v1alpha1.ProposerSlashing
	9,  // 51: zond.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.attester_slashings:type_name -> zond.eth.v1alpha1.AttesterSlashing
	36, // 52: zond.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.attestations:type_name -> zond.eth.v1alpha1.Attestation
	10, // 53: zond.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.deposits:type_name -> zond.eth.v1alpha1.Deposit
	12, // 54: zond.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.voluntary_exits:type_name -> zond.eth.v1alpha1.SignedVoluntaryExit
	17, // 55: zond.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.sync_aggregate:type_name -> zond.eth.v1alpha1.SyncAggregate
	39, // 56: zond.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader
	25, // 57: zond.eth.v1alpha1.SignedBeaconBlockCapella.block:type_name -> zond.eth.v1alpha1.BeaconBlockCapella
	26, // 58: zond.eth.v1alpha1.BeaconBlockCapella.body:type_name -> zond.eth.v1alpha1.BeaconBlockBodyCapella
	13, // 59: zond.eth.v1alpha1.BeaconBlockBodyCapella.eth1_data:type_name -> zond.eth.v1alpha1.Eth1Data
	8,  // 60: zond.eth.v1alpha1.BeaconBlockBodyCapella.proposer_slashings:type_name -> zond.eth.v1alpha1.ProposerSlashing
	9,  // 61: zond.eth.v1alpha1.BeaconBlockBodyCapella.attester_slashings:type_name -> zond.eth.v1alpha1.AttesterSlashing
	36, // 62: zond.eth.v1alpha1.BeaconBlockBodyCapella.attestations:type_name -> zond.eth.v1alpha1.Attestation
	10, // 63: zond.eth.v1alpha1.BeaconBlockBodyCapella.deposits:type_name -> zond.eth.v1alpha1.Deposit
	12, // 64: zond.eth.v1alpha1.BeaconBlockBodyCapella.voluntary_exits:type_name -> zond.eth.v1alpha1.SignedVoluntaryExit
	17, // 65: zond.eth.v1alpha1.BeaconBlockBodyCapella.sync_aggregate:type_name -> zond.eth.v1alpha1.SyncAggregate
	40, // 66: zond.eth.v1alpha1.BeaconBlockBodyCapella.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayloadCapella
	41, // 67: zond.eth.v1alpha1.BeaconBlockBodyCapella.bls_to_execution_changes:type_name -> zond.eth.v1alpha1.SignedBLSToExecutionChange
	28, // 68: zond.eth.v1alpha1.SignedBlindedBeaconBlockCapella.block:type_name -> zond.eth.v1alpha1.BlindedBeaconBlockCapella
	29, // 69: zond.eth.v1alpha1.BlindedBeaconBlockCapella.body:type_name -> zond.eth.v1alpha1.BlindedBeaconBlockBodyCapella
	13, // 70: zond.eth.v1alpha1.BlindedBeaconBlockBodyCapella.eth1_data:type_name -> zond.eth.v1alpha1.Eth1Data
	8,  // 71: zond.eth.v1alpha1.BlindedBeaconBlockBodyCapella.proposer_slashings:type_name -> zond.eth.v1alpha1.ProposerSlashing
	9,  // 72: zond.eth.v1alpha1.BlindedBeaconBlockBodyCapella.attester_slashings:type_name -> zond.eth.v1alpha1.AttesterSlashing
	36, // 73: zond.eth.v1alpha1.BlindedBeaconBlockBodyCapella.attestations:type_name -> zond.eth.v1alpha1.Attestation
	10, // 74: zond.eth.v1alpha1.BlindedBeaconBlockBodyCapella.deposits:type_name -> zond.eth.v1alpha1.Deposit
	12, // 75: zond.eth.v1alpha1.BlindedBeaconBlockBodyCapella.voluntary_exits:type_name -> zond.eth.v1alpha1.SignedVoluntaryExit
	17, // 76: zond.eth.v1alpha1.BlindedBeaconBlockBodyCapella.sync_aggregate:type_name -> zond.eth.v1alpha1.SyncAggregate
	42, // 77: zond.eth.v1alpha1.BlindedBeaconBlockBodyCapella.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderCapella
	41, // 78: zond.eth.v1alpha1.BlindedBeaconBlockBodyCapella.bls_to_execution_changes:type_name -> zond.eth.v1alpha1.SignedBLSToExecutionChange
	32, // 79: zond.eth.v1alpha1.SignedValidatorRegistrationsV1.messages:type_name -> zond.eth.v1alpha1.SignedValidatorRegistrationV1
	30, // 80: zond.eth.v1alpha1.SignedValidatorRegistrationV1.message:type_name -> zond.eth.v1alpha1.ValidatorRegistrationV1
	39, // 81: zond.eth.v1alpha1.BuilderBid.header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader
	33, // 82: zond.eth.v1alpha1.SignedBuilderBid.message:type_name -> zond.eth.v1alpha1.BuilderBid
