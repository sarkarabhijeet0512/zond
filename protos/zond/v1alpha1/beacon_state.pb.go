...
// 	protoc        v3.15.8
// source: protos/zond/v1alpha1/beacon_state.proto
...
type BeaconState struct {
	...
	Slot                        github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot `protobuf:"varint,1003,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
...
type PendingAttestation struct {
	...
	InclusionDelay  github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot           `protobuf:"varint,3,opt,name=inclusion_delay,json=inclusionDelay,proto3" json:"inclusion_delay,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
	ProposerIndex   github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex `protobuf:"varint,4,opt,name=proposer_index,json=proposerIndex,proto3" json:"proposer_index,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.ValidatorIndex"`
}
...
var file_proto_prysm_v1alpha1_beacon_state_proto_goTypes = []interface{}{
	(*BeaconState)(nil),                      // 0: zond.eth.v1alpha1.BeaconState
	(*BeaconStateAltair)(nil),                // 1: zond.eth.v1alpha1.BeaconStateAltair
	(*Fork)(nil),                             // 2: zond.eth.v1alpha1.Fork
	(*PendingAttestation)(nil),               // 3: zond.eth.v1alpha1.PendingAttestation
	(*HistoricalBatch)(nil),                  // 4: zond.eth.v1alpha1.HistoricalBatch
	(*StateSummary)(nil),                     // 5: zond.eth.v1alpha1.StateSummary
	(*SigningData)(nil),                      // 6: zond.eth.v1alpha1.SigningData
	(*ForkData)(nil),                         // 7: zond.eth.v1alpha1.ForkData
	(*CheckPtInfo)(nil),                      // 8: zond.eth.v1alpha1.CheckPtInfo
	(*DepositMessage)(nil),                   // 9: zond.eth.v1alpha1.DepositMessage
	(*SyncCommittee)(nil),                    // 10: zond.eth.v1alpha1.SyncCommittee
	(*SyncAggregatorSelectionData)(nil),      // 11: zond.eth.v1alpha1.SyncAggregatorSelectionData
	(*BeaconStateBellatrix)(nil),             // 12: zond.eth.v1alpha1.BeaconStateBellatrix
	(*BeaconStateCapella)(nil),               // 13: zond.eth.v1alpha1.BeaconStateCapella
	(*PowBlock)(nil),                         // 14: zond.eth.v1alpha1.PowBlock
	(*BeaconBlockHeader)(nil),                // 15: zond.eth.v1alpha1.BeaconBlockHeader
	(*Eth1Data)(nil),                         // 16: zond.eth.v1alpha1.Eth1Data
	(*Validator)(nil),                        // 17: zond.eth.v1alpha1.Validator
	(*Checkpoint)(nil),                       // 18: zond.eth.v1alpha1.Checkpoint
	(*AttestationData)(nil),                  // 19: zond.eth.v1alpha1.AttestationData
...
var file_proto_prysm_v1alpha1_beacon_state_proto_depIdxs = []int32{
	2,  // 0: zond.eth.v1alpha1.BeaconState.fork:type_name -> zond.eth.v1alpha1.Fork
	15, // 1: zond.eth.v1alpha1.BeaconState.latest_block_header:type_name -> zond.eth.v1alpha1.BeaconBlockHeader
	16, // 2: zond.eth.v1alpha1.BeaconState.eth1_data:type_name -> zond.eth.v1alpha1.Eth1Data
	16, // 3: zond.eth.v1alpha1.BeaconState.eth1_data_votes:type_name -> zond.eth.v1alpha1.Eth1Data
	17, // 4: zond.eth.v1alpha1.BeaconState.validators:type_name -> zond.eth.v1alpha1.Validator
	3,  // 5: zond.eth.v1alpha1.BeaconState.previous_epoch_attestations:type_name -> zond.eth.v1alpha1.PendingAttestation
	3,  // 6: zond.eth.v1alpha1.BeaconState.current_epoch_attestations:type_name -> zond.eth.v1alpha1.PendingAttestation
	18, // 7: zond.eth.v1alpha1.BeaconState.previous_justified_checkpoint:type_name -> zond.eth.v1alpha1.Checkpoint
	18, // 8: zond.eth.v1alpha1.BeaconState.current_justified_checkpoint:type_name -> zond.eth.v1alpha1.Checkpoint
	18, // 9: zond.eth.v1alpha1.BeaconState.finalized_checkpoint:type_name -> zond.eth.v1alpha1.Checkpoint
	2,  // 10: zond.eth.v1alpha1.BeaconStateAltair.fork:type_name -> zond.eth.v1alpha1.Fork
	15, // 11: zond.eth.v1alpha1.BeaconStateAltair.latest_block_header:type_name -> zond.eth.v1alpha1.BeaconBlockHeader
	16, // 12: zond.eth.v1alpha1.BeaconStateAltair.eth1_data:type_name -> zond.eth.v1alpha1.Eth1Data
	16, // 13: zond.eth.v1alpha1.BeaconStateAltair.eth1_data_votes:type_name -> zond.eth.v1alpha1.Eth1Data
	17, // 14: zond.eth.v1alpha1.BeaconStateAltair.validators:type_name -> zond.eth.v1alpha1.Validator
	18, // 15: zond.eth.v1alpha1.BeaconStateAltair.previous_justified_checkpoint:type_name -> zond.eth.v1alpha1.Checkpoint
	18, // 16: zond.eth.v1alpha1.BeaconStateAltair.current_justified_checkpoint:type_name -> zond.eth.v1alpha1.Checkpoint
	18, // 17: zond.eth.v1alpha1.BeaconStateAltair.finalized_checkpoint:type_name -> zond.eth.v1alpha1.Checkpoint
	10, // 18: zond.eth.v1alpha1.BeaconStateAltair.current_sync_committee:type_name -> zond.eth.v1alpha1.SyncCommittee
	10, // 19: zond.eth.v1alpha1.BeaconStateAltair.next_sync_committee:type_name -> zond.eth.v1alpha1.SyncCommittee
	19, // 20: zond.eth.v1alpha1.PendingAttestation.data:type_name -> zond.eth.v1alpha1.AttestationData
	2,  // 21: zond.eth.v1alpha1.CheckPtInfo.fork:type_name -> zond.eth.v1alpha1.Fork
	2,  // 22: zond.eth.v1alpha1.BeaconStateBellatrix.fork:type_name -> zond.eth.v1alpha1.Fork
	15, // 23: zond.eth.v1alpha1.BeaconStateBellatrix.latest_block_header:type_name -> zond.eth.v1alpha1.BeaconBlockHeader
	16, // 24: zond.eth.v1alpha1.BeaconStateBellatrix.eth1_data:type_name -> zond.eth.v1alpha1.Eth1Data
	16, // 25: zond.eth.v1alpha1.BeaconStateBellatrix.eth1_data_votes:type_name -> zond.eth.v1alpha1.Eth1Data
	17, // 26: zond.eth.v1alpha1.BeaconStateBellatrix.validators:type_name -> zond.eth.v1alpha1.Validator
	18, // 27: zond.eth.v1alpha1.BeaconStateBellatrix.previous_justified_checkpoint:type_name -> zond.eth.v1alpha1.Checkpoint
	18, // 28: zond.eth.v1alpha1.BeaconStateBellatrix.current_justified_checkpoint:type_name -> zond.eth.v1alpha1.Checkpoint
	18, // 29: zond.eth.v1alpha1.BeaconStateBellatrix.finalized_checkpoint:type_name -> zond.eth.v1alpha1.Checkpoint
	10, // 30: zond.eth.v1alpha1.BeaconStateBellatrix.current_sync_committee:type_name -> zond.eth.v1alpha1.SyncCommittee
	10, // 31: zond.eth.v1alpha1.BeaconStateBellatrix.next_sync_committee:type_name -> zond.eth.v1alpha1.SyncCommittee
	20, // 32: zond.eth.v1alpha1.BeaconStateBellatrix.latest_execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader
	2,  // 33: zond.eth.v1alpha1.BeaconStateCapella.fork:type_name -> zond.eth.v1alpha1.Fork
	15, // 34: zond.eth.v1alpha1.BeaconStateCapella.latest_block_header:type_name -> zond.eth.v1alpha1.BeaconBlockHeader
	16, // 35: zond.eth.v1alpha1.BeaconStateCapella.eth1_data:type_name -> zond.eth.v1alpha1.Eth1Data
	16, // 36: zond.eth.v1alpha1.BeaconStateCapella.eth1_data_votes:type_name -> zond.eth.v1alpha1.Eth1Data
	17, // 37: zond.eth.v1alpha1.BeaconStateCapella.validators:type_name -> zond.eth.v1alpha1.Validator
	18, // 38: zond.eth.v1alpha1.BeaconStateCapella.previous_justified_checkpoint:type_name -> zond.eth.v1alpha1.Checkpoint
	18, // 39: zond.eth.v1alpha1.BeaconStateCapella.current_justified_checkpoint:type_name -> zond.eth.v1alpha1.Checkpoint
	18, // 40: zond.eth.v1alpha1.BeaconStateCapella.finalized_checkpoint:type_name -> zond.eth.v1alpha1.Checkpoint
	10, // 41: zond.eth.v1alpha1.BeaconStateCapella.current_sync_committee:type_name -> zond.eth.v1alpha1.SyncCommittee
	10, // 42: zond.eth.v1alpha1.BeaconStateCapella.next_sync_committee:type_name -> zond.eth.v1alpha1.SyncCommittee
	21, // 43: zond.eth.v1alpha1.BeaconStateCapella.latest_execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderCapella
	22, // 44: zond.eth.v1alpha1.BeaconStateCapella.withdrawal_queue:type_name -> ethereum.engine.v1.Withdrawal
