...
// 	protoc        v3.15.8
// source: protos/eth/v1/beacon_chain.proto
...
type StateValidatorsRequest struct {
	...
	Status  []ValidatorStatus `protobuf:"varint,3,rep,packed,name=status,proto3,enum=zond.eth.v1.ValidatorStatus" json:"status,omitempty"`
}
...
type StateCommitteesRequest struct {
	...
	StateId []byte                                                                       `protobuf:"bytes,1,opt,name=state_id,json=stateId,proto3" json:"state_id,omitempty"`
	Epoch   *github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch          `protobuf:"varint,2,opt,name=epoch,proto3,oneof" json:"epoch,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Epoch"`
	Index   *github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.CommitteeIndex `protobuf:"varint,3,opt,name=index,proto3,oneof" json:"index,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.CommitteeIndex"`
	Slot    *github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot           `protobuf:"varint,4,opt,name=slot,proto3,oneof" json:"slot,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
}
...
type BlockHeadersRequest struct {
	...
	Slot       *github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot `protobuf:"varint,1,opt,name=slot,proto3,oneof" json:"slot,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
...
type AttestationsPoolRequest struct {
	...
	Slot           *github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot           `protobuf:"varint,1,opt,name=slot,proto3,oneof" json:"slot,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
	CommitteeIndex *github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.CommitteeIndex `protobuf:"varint,2,opt,name=committee_index,json=committeeIndex,proto3,oneof" json:"committee_index,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.CommitteeIndex"`
}
...
type ForkChoiceNode struct {
	...
	JustifiedEpoch           github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch `protobuf:"varint,4,opt,name=justified_epoch,json=justifiedEpoch,proto3" json:"justified_epoch,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Epoch"`
	...
	UnrealizedJustifiedEpoch github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch `protobuf:"varint,6,opt,name=unrealized_justified_epoch,json=unrealizedJustifiedEpoch,proto3" json:"unrealized_justified_epoch,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Epoch"`
	UnrealizedFinalizedEpoch github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch `protobuf:"varint,7,opt,name=unrealized_finalized_epoch,json=unrealizedFinalizedEpoch,proto3" json:"unrealized_finalized_epoch,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Epoch"`
...
var file_proto_eth_v1_beacon_chain_proto_goTypes = []interface{}{
	(*GenesisResponse)(nil),                                         // 0: zond.eth.v1.GenesisResponse
	(*StateRequest)(nil),                                            // 1: zond.eth.v1.StateRequest
	(*StateRootResponse)(nil),                                       // 2: zond.eth.v1.StateRootResponse
	(*StateForkResponse)(nil),                                       // 3: zond.eth.v1.StateForkResponse
	(*StateFinalityCheckpointResponse)(nil),                         // 4: zond.eth.v1.StateFinalityCheckpointResponse
	(*StateValidatorsRequest)(nil),                                  // 5: zond.eth.v1.StateValidatorsRequest
	(*ValidatorBalancesRequest)(nil),                                // 6: zond.eth.v1.ValidatorBalancesRequest
	(*StateValidatorsResponse)(nil),                                 // 7: zond.eth.v1.StateValidatorsResponse
	(*ValidatorBalancesResponse)(nil),                               // 8: zond.eth.v1.ValidatorBalancesResponse
	(*ValidatorBalance)(nil),                                        // 9: zond.eth.v1.ValidatorBalance
	(*StateValidatorRequest)(nil),                                   // 10: zond.eth.v1.StateValidatorRequest
	(*StateValidatorResponse)(nil),                                  // 11: zond.eth.v1.StateValidatorResponse
	(*StateCommitteesRequest)(nil),                                  // 12: zond.eth.v1.StateCommitteesRequest
	(*StateCommitteesResponse)(nil),                                 // 13: zond.eth.v1.StateCommitteesResponse
	(*BlockAttestationsResponse)(nil),                               // 14: zond.eth.v1.BlockAttestationsResponse
	(*BlockRootContainer)(nil),                                      // 15: zond.eth.v1.BlockRootContainer
	(*BlockRootResponse)(nil),                                       // 16: zond.eth.v1.BlockRootResponse
	(*BlockHeadersRequest)(nil),                                     // 17: zond.eth.v1.BlockHeadersRequest
	(*BlockHeadersResponse)(nil),                                    // 18: zond.eth.v1.BlockHeadersResponse
	(*BlockRequest)(nil),                                            // 19: zond.eth.v1.BlockRequest
	(*BlockHeaderResponse)(nil),                                     // 20: zond.eth.v1.BlockHeaderResponse
	(*BlockHeaderContainer)(nil),                                    // 21: zond.eth.v1.BlockHeaderContainer
	(*BeaconBlockHeaderContainer)(nil),                              // 22: zond.eth.v1.BeaconBlockHeaderContainer
	(*BlockResponse)(nil),                                           // 23: zond.eth.v1.BlockResponse
	(*BlockSSZResponse)(nil),                                        // 24: zond.eth.v1.BlockSSZResponse
	(*BeaconBlockContainer)(nil),                                    // 25: zond.eth.v1.BeaconBlockContainer
	(*AttestationsPoolRequest)(nil),                                 // 26: zond.eth.v1.AttestationsPoolRequest
	(*SubmitAttestationsRequest)(nil),                               // 27: zond.eth.v1.SubmitAttestationsRequest
	(*AttestationsPoolResponse)(nil),                                // 28: zond.eth.v1.AttestationsPoolResponse
	(*AttesterSlashingsPoolResponse)(nil),                           // 29: zond.eth.v1.AttesterSlashingsPoolResponse
	(*ProposerSlashingPoolResponse)(nil),                            // 30: zond.eth.v1.ProposerSlashingPoolResponse
	(*VoluntaryExitsPoolResponse)(nil),                              // 31: zond.eth.v1.VoluntaryExitsPoolResponse
	(*ForkScheduleResponse)(nil),                                    // 32: zond.eth.v1.ForkScheduleResponse
	(*SpecResponse)(nil),                                            // 33: zond.eth.v1.SpecResponse
	(*DepositContractResponse)(nil),                                 // 34: zond.eth.v1.DepositContractResponse
	(*DepositContract)(nil),                                         // 35: zond.eth.v1.DepositContract
	(*WeakSubjectivityResponse)(nil),                                // 36: zond.eth.v1.WeakSubjectivityResponse
	(*WeakSubjectivityData)(nil),                                    // 37: zond.eth.v1.WeakSubjectivityData
	(*ForkChoiceResponse)(nil),                                      // 38: zond.eth.v1.ForkChoiceResponse
	(*ForkChoiceNode)(nil),                                          // 39: zond.eth.v1.ForkChoiceNode
	(*GenesisResponse_Genesis)(nil),                                 // 40: zond.eth.v1.GenesisResponse.Genesis
	(*StateRootResponse_StateRoot)(nil),                             // 41: zond.eth.v1.StateRootResponse.StateRoot
	(*StateFinalityCheckpointResponse_StateFinalityCheckpoint)(nil), // 42: zond.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint
	nil,                           // 43: zond.eth.v1.SpecResponse.DataEntry
	(*Fork)(nil),                  // 44: zond.eth.v1.Fork
	(ValidatorStatus)(0),          // 45: zond.eth.v1.ValidatorStatus
	(*ValidatorContainer)(nil),    // 46: zond.eth.v1.ValidatorContainer
	(*Committee)(nil),             // 47: zond.eth.v1.Committee
	(*Attestation)(nil),           // 48: zond.eth.v1.Attestation
	(*BeaconBlockHeader)(nil),     // 49: zond.eth.v1.BeaconBlockHeader
	(*BeaconBlock)(nil),           // 50: zond.eth.v1.BeaconBlock
	(*AttesterSlashing)(nil),      // 51: zond.eth.v1.AttesterSlashing
	(*ProposerSlashing)(nil),      // 52: zond.eth.v1.ProposerSlashing
	(*SignedVoluntaryExit)(nil),   // 53: zond.eth.v1.SignedVoluntaryExit
	(*Checkpoint)(nil),            // 54: zond.eth.v1.Checkpoint
	(*timestamppb.Timestamp)(nil), // 55: google.protobuf.Timestamp
}
var file_proto_eth_v1_beacon_chain_proto_depIdxs = []int32{
	40, // 0: zond.eth.v1.GenesisResponse.data:type_name -> zond.eth.v1.GenesisResponse.Genesis
	41, // 1: zond.eth.v1.StateRootResponse.data:type_name -> zond.eth.v1.StateRootResponse.StateRoot
	44, // 2: zond.eth.v1.StateForkResponse.data:type_name -> zond.eth.v1.Fork
	42, // 3: zond.eth.v1.StateFinalityCheckpointResponse.data:type_name -> zond.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint
	45, // 4: zond.eth.v1.StateValidatorsRequest.status:type_name -> zond.eth.v1.ValidatorStatus
	46, // 5: zond.eth.v1.StateValidatorsResponse.data:type_name -> zond.eth.v1.ValidatorContainer
	9,  // 6: zond.eth.v1.ValidatorBalancesResponse.data:type_name -> zond.eth.v1.ValidatorBalance
	46, // 7: zond.eth.v1.StateValidatorResponse.data:type_name -> zond.eth.v1.ValidatorContainer
	47, // 8: zond.eth.v1.StateCommitteesResponse.data:type_name -> zond.eth.v1.Committee
	48, // 9: zond.eth.v1.BlockAttestationsResponse.data:type_name -> zond.eth.v1.Attestation
	15, // 10: zond.eth.v1.BlockRootResponse.data:type_name -> zond.eth.v1.BlockRootContainer
	21, // 11: zond.eth.v1.BlockHeadersResponse.data:type_name -> zond.eth.v1.BlockHeaderContainer
	21, // 12: zond.eth.v1.BlockHeaderResponse.data:type_name -> zond.eth.v1.BlockHeaderContainer
	22, // 13: zond.eth.v1.BlockHeaderContainer.header:type_name -> zond.eth.v1.BeaconBlockHeaderContainer
	49, // 14: zond.eth.v1.BeaconBlockHeaderContainer.message:type_name -> zond.eth.v1.BeaconBlockHeader
	25, // 15: zond.eth.v1.BlockResponse.data:type_name -> zond.eth.v1.BeaconBlockContainer
	50, // 16: zond.eth.v1.BeaconBlockContainer.message:type_name -> zond.eth.v1.BeaconBlock
	48, // 17: zond.eth.v1.SubmitAttestationsRequest.data:type_name -> zond.eth.v1.Attestation
	48, // 18: zond.eth.v1.AttestationsPoolResponse.data:type_name -> zond.eth.v1.Attestation
	51, // 19: zond.eth.v1.AttesterSlashingsPoolResponse.data:type_name -> zond.eth.v1.AttesterSlashing
	52, // 20: zond.eth.v1.ProposerSlashingPoolResponse.data:type_name -> zond.eth.v1.ProposerSlashing
	53, // 21: zond.eth.v1.VoluntaryExitsPoolResponse.data:type_name -> zond.eth.v1.SignedVoluntaryExit
	44, // 22: zond.eth.v1.ForkScheduleResponse.data:type_name -> zond.eth.v1.Fork
	43, // 23: zond.eth.v1.SpecResponse.data:type_name -> zond.eth.v1.SpecResponse.DataEntry
	35, // 24: zond.eth.v1.DepositContractResponse.data:type_name -> zond.eth.v1.DepositContract
	37, // 25: zond.eth.v1.WeakSubjectivityResponse.data:type_name -> zond.eth.v1.WeakSubjectivityData
	54, // 26: zond.eth.v1.WeakSubjectivityData.ws_checkpoint:type_name -> zond.eth.v1.Checkpoint
	54, // 27: zond.eth.v1.ForkChoiceResponse.justified_checkpoint:type_name -> zond.eth.v1.Checkpoint
	54, // 28: zond.eth.v1.ForkChoiceResponse.finalized_checkpoint:type_name -> zond.eth.v1.Checkpoint
	54, // 29: zond.eth.v1.ForkChoiceResponse.best_justified_checkpoint:type_name -> zond.eth.v1.Checkpoint
	54, // 30: zond.eth.v1.ForkChoiceResponse.unrealized_justified_checkpoint:type_name -> zond.eth.v1.Checkpoint
	54, // 31: zond.eth.v1.ForkChoiceResponse.unrealized_finalized_checkpoint:type_name -> zond.eth.v1.Checkpoint
	39, // 32: zond.eth.v1.ForkChoiceResponse.forkchoice_nodes:type_name -> zond.eth.v1.ForkChoiceNode
	55, // 33: zond.eth.v1.GenesisResponse.Genesis.genesis_time:type_name -> google.protobuf.Timestamp
	54, // 34: zond.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint.previous_justified:type_name -> zond.eth.v1.Checkpoint
	54, // 35: zond.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint.current_justified:type_name -> zond.eth.v1.Checkpoint
	54, // 36: zond.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint.finalized:type_name -> zond.eth.v1.Checkpoint
