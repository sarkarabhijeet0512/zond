...
// 	protoc        v3.15.8
// source: protos/eth/v1/node.proto
...
type Identity struct {
	...
	Znr                string    `protobuf:"bytes,2,opt,name=znr,proto3" json:"znr,omitempty"`
...
type PeersRequest struct {
	...
	State     []ConnectionState `protobuf:"varint,1,rep,packed,name=state,proto3,enum=zond.eth.v1.ConnectionState" json:"state,omitempty"`
	Direction []PeerDirection   `protobuf:"varint,2,rep,packed,name=direction,proto3,enum=zond.eth.v1.PeerDirection" json:"direction,omitempty"`
}
...
type Peer struct {
	...
	State              ConnectionState `protobuf:"varint,4,opt,name=state,proto3,enum=zond.eth.v1.ConnectionState" json:"state,omitempty"`
	Direction          PeerDirection   `protobuf:"varint,5,opt,name=direction,proto3,enum=zond.eth.v1.PeerDirection" json:"direction,omitempty"`
}
...
type SyncInfo struct {
	...
	SyncDistance github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot `protobuf:"varint,2,opt,name=sync_distance,json=syncDistance,proto3" json:"sync_distance,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
...
func (x *SyncInfo) GetHeadSlot() github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot {
	if x != nil {
		return x.HeadSlot
	}
...
func (x *SyncInfo) GetSyncDistance() github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot {
	if x != nil {
...
func (x *SyncInfo) GetIsOptimistic() bool {
	if x != nil {
...
var file_proto_eth_v1_node_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x74, 0x6e, 0x65, 0x74, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x39, 0x8a,
	0xb5, 0x18, 0x01, 0x38, 0x82, 0xb5, 0x18, 0x30, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	...
	0x76, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x36, 0x34, 0x52, 0x07, 0x61, 0x74, 0x74, 0x6e, 0x65, 0x74,
	...
	0x40, 0x0a, 0x0f, 0x53, 0x79, 0x6e, 0x63, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x76, 0x31, 0x2e, 0x53, 0x79, 0x6e, 0x63, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x22, 0x9e, 0x02, 0x0a, 0x08, 0x53, 0x79, 0x6e, 0x63, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x62,
	...
	0x6f, 0x74, 0x12, 0x6a, 0x0a, 0x0d, 0x73, 0x79, 0x6e, 0x63, 0x5f, 0x64, 0x69, 0x73, 0x74, 0x61,
	0x6e, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x42, 0x45, 0x82, 0xb5, 0x18, 0x41, 0x67,
	...
	,
...
var file_proto_eth_v1_node_proto_goTypes = []interface{}{
	(PeerDirection)(0),                  // 0: zond.eth.v1.PeerDirection
	(ConnectionState)(0),                // 1: zond.eth.v1.ConnectionState
	(*IdentityResponse)(nil),            // 2: zond.eth.v1.IdentityResponse
	(*Identity)(nil),                    // 3: zond.eth.v1.Identity
	(*Metadata)(nil),                    // 4: zond.eth.v1.Metadata
	(*PeerRequest)(nil),                 // 5: zond.eth.v1.PeerRequest
	(*PeersRequest)(nil),                // 6: zond.eth.v1.PeersRequest
	(*PeerResponse)(nil),                // 7: zond.eth.v1.PeerResponse
	(*PeersResponse)(nil),               // 8: zond.eth.v1.PeersResponse
	(*PeerCountResponse)(nil),           // 9: zond.eth.v1.PeerCountResponse
	(*Peer)(nil),                        // 10: zond.eth.v1.Peer
	(*VersionResponse)(nil),             // 11: zond.eth.v1.VersionResponse
	(*Version)(nil),                     // 12: zond.eth.v1.Version
	(*SyncingResponse)(nil),             // 13: zond.eth.v1.SyncingResponse
	(*SyncInfo)(nil),                    // 14: zond.eth.v1.SyncInfo
	(*PeerResponse_Meta)(nil),           // 15: zond.eth.v1.PeerResponse.Meta
	(*PeerCountResponse_PeerCount)(nil), // 16: zond.eth.v1.PeerCountResponse.PeerCount
}
var file_proto_eth_v1_node_proto_depIdxs = []int32{
	3,  // 0: zond.eth.v1.IdentityResponse.data:type_name -> zond.eth.v1.Identity
	4,  // 1: zond.eth.v1.Identity.metadata:type_name -> zond.eth.v1.Metadata
	1,  // 2: zond.eth.v1.PeersRequest.state:type_name -> zond.eth.v1.ConnectionState
	0,  // 3: zond.eth.v1.PeersRequest.direction:type_name -> zond.eth.v1.PeerDirection
	10, // 4: zond.eth.v1.PeerResponse.data:type_name -> zond.eth.v1.Peer
	15, // 5: zond.eth.v1.PeerResponse.meta:type_name -> zond.eth.v1.PeerResponse.Meta
	10, // 6: zond.eth.v1.PeersResponse.data:type_name -> zond.eth.v1.Peer
	16, // 7: zond.eth.v1.PeerCountResponse.data:type_name -> zond.eth.v1.PeerCountResponse.PeerCount
	1,  // 8: zond.eth.v1.Peer.state:type_name -> zond.eth.v1.ConnectionState
	0,  // 9: zond.eth.v1.Peer.direction:type_name -> zond.eth.v1.PeerDirection
	12, // 10: zond.eth.v1.VersionResponse.data:type_name -> zond.eth.v1.Version
	14, // 11: zond.eth.v1.SyncingResponse.data:type_name -> zond.eth.v1.SyncInfo
