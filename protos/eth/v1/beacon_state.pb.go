...
// 	protoc        v3.15.8
// source: protos/eth/v1/beacon_state.proto
...
type Committee struct {
	...
	Index      github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.CommitteeIndex   `protobuf:"varint,1,opt,name=index,proto3" json:"index,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.CommitteeIndex"`
	...
	Validators []github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex `protobuf:"varint,3,rep,packed,name=validators,proto3" json:"validators,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.ValidatorIndex"`
}
...
func (x *Committee) GetIndex() github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.CommitteeIndex {
	if x != nil {
		return x.Index
	}
...
func (x *Committee) GetSlot() github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot(0)
...
func (x *Committee) GetValidators() []github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex {
	if x != nil {
		return x.Validators
	}
...
var file_proto_eth_v1_beacon_state_proto_rawDesc = []byte{
	...
	0x73, 0x6d, 0x61, 0x74, 0x69, 0x63, 0x6c, 0x61, 0x62, 0x73, 0x2f, 0x70, 0x72, 0x79, 0x73, 0x6d,
	0x2f, 0x76, 0x33, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x65, 0x74, 0x68, 0x2f, 0x76, 0x31,
...
var file_proto_eth_v1_beacon_state_proto_goTypes = []interface{}{
	(*BeaconState)(nil),             // 0: zond.eth.v1.BeaconState
	(*PendingAttestation)(nil),      // 1: zond.eth.v1.PendingAttestation
	(*Committee)(nil),               // 2: zond.eth.v1.Committee
	(*Fork)(nil),                    // 3: zond.eth.v1.Fork
	(*ForkChoiceHeadsResponse)(nil), // 4: zond.eth.v1.ForkChoiceHeadsResponse
	(*ForkChoiceHead)(nil),          // 5: zond.eth.v1.ForkChoiceHead
	(*BeaconStateResponse)(nil),     // 6: zond.eth.v1.BeaconStateResponse
	(*BeaconBlockHeader)(nil),       // 7: zond.eth.v1.BeaconBlockHeader
	(*Eth1Data)(nil),                // 8: zond.eth.v1.Eth1Data
	(*Validator)(nil),               // 9: zond.eth.v1.Validator
	(*Checkpoint)(nil),              // 10: zond.eth.v1.Checkpoint
	(*AttestationData)(nil),         // 11: zond.eth.v1.AttestationData
}
var file_proto_eth_v1_beacon_state_proto_depIdxs = []int32{
	3,  // 0: zond.eth.v1.BeaconState.fork:type_name -> zond.eth.v1.Fork
	7,  // 1: zond.eth.v1.BeaconState.latest_block_header:type_name -> zond.eth.v1.BeaconBlockHeader
	8,  // 2: zond.eth.v1.BeaconState.eth1_data:type_name -> zond.eth.v1.Eth1Data
	8,  // 3: zond.eth.v1.BeaconState.eth1_data_votes:type_name -> zond.eth.v1.Eth1Data
	9,  // 4: zond.eth.v1.BeaconState.validators:type_name -> zond.eth.v1.Validator
	1,  // 5: zond.eth.v1.BeaconState.previous_epoch_attestations:type_name -> zond.eth.v1.PendingAttestation
	1,  // 6: zond.eth.v1.BeaconState.current_epoch_attestations:type_name -> zond.eth.v1.PendingAttestation
	10, // 7: zond.eth.v1.BeaconState.previous_justified_checkpoint:type_name -> zond.eth.v1.Checkpoint
	10, // 8: zond.eth.v1.BeaconState.current_justified_checkpoint:type_name -> zond.eth.v1.Checkpoint
	10, // 9: zond.eth.v1.BeaconState.finalized_checkpoint:type_name -> zond.eth.v1.Checkpoint
	11, // 10: zond.eth.v1.PendingAttestation.data:type_name -> zond.eth.v1.AttestationData
	5,  // 11: zond.eth.v1.ForkChoiceHeadsResponse.data:type_name -> zond.eth.v1.ForkChoiceHead
	0,  // 12: zond.eth.v1.BeaconStateResponse.data:type_name -> zond.eth.v1.BeaconState
