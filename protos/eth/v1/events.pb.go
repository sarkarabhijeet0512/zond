...
// 	protoc        v3.15.8
// source: protos/eth/v1/events.proto
...
type EventChainReorg struct {
	...
	Epoch               github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch `protobuf:"varint,7,opt,name=epoch,proto3" json:"epoch,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Epoch"`
...
var file_proto_eth_v1_events_proto_goTypes = []interface{}{
	(*StreamEventsRequest)(nil),      // 0: zond.eth.v1.StreamEventsRequest
	(*EventHead)(nil),                // 1: zond.eth.v1.EventHead
	(*EventBlock)(nil),               // 2: zond.eth.v1.EventBlock
	(*EventChainReorg)(nil),          // 3: zond.eth.v1.EventChainReorg
	(*EventFinalizedCheckpoint)(nil), // 4: zond.eth.v1.EventFinalizedCheckpoint
}
