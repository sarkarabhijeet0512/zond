...
// 	protoc        v3.15.8
// source: protos/eth/v1/validator.proto
...
type ValidatorContainer struct {
	...
	Status    ValidatorStatus                                                             `protobuf:"varint,3,opt,name=status,proto3,enum=zond.eth.v1.ValidatorStatus" json:"status,omitempty"`
...
type AttesterDutiesRequest struct {
	...
	Index []github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex `protobuf:"varint,2,rep,packed,name=index,proto3" json:"index,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.ValidatorIndex"`
}
...
type AttesterDuty struct {
	...
	CommitteeIndex          github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.CommitteeIndex `protobuf:"varint,3,opt,name=committee_index,json=committeeIndex,proto3" json:"committee_index,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.CommitteeIndex"`
	...
	ValidatorCommitteeIndex github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.CommitteeIndex `protobuf:"varint,6,opt,name=validator_committee_index,json=validatorCommitteeIndex,proto3" json:"validator_committee_index,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.CommitteeIndex"`
	Slot                    github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot           `protobuf:"varint,7,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
}
...
type ProposerDuty struct {
	...
	Pubkey         []byte                                                                      `protobuf:"bytes,1,opt,name=pubkey,proto3" json:"pubkey,omitempty" ssz-size:"48"`
	ValidatorIndex github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex `protobuf:"varint,2,opt,name=validator_index,json=validatorIndex,proto3" json:"validator_index,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.ValidatorIndex"`
	Slot           github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot           `protobuf:"varint,3,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
}
...
type BeaconCommitteeSubscribe struct {
	...
	ValidatorIndex   github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,opt,name=validator_index,json=validatorIndex,proto3" json:"validator_index,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.ValidatorIndex"`
	CommitteeIndex   github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.CommitteeIndex `protobuf:"varint,2,opt,name=committee_index,json=committeeIndex,proto3" json:"committee_index,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.CommitteeIndex"`
	...
	Slot             github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot           `protobuf:"varint,4,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.Slot"`
...
var file_proto_eth_v1_validator_proto_goTypes = []interface{}{
	(ValidatorStatus)(0),                                                    // 0: zond.eth.v1.ValidatorStatus
	(*ValidatorContainer)(nil),                                              // 1: zond.eth.v1.ValidatorContainer
	(*Validator)(nil),                                                       // 2: zond.eth.v1.Validator
	(*AttesterDutiesRequest)(nil),                                           // 3: zond.eth.v1.AttesterDutiesRequest
	(*AttesterDutiesResponse)(nil),                                          // 4: zond.eth.v1.AttesterDutiesResponse
	(*AttesterDuty)(nil),                                                    // 5: zond.eth.v1.AttesterDuty
	(*ProposerDutiesRequest)(nil),                                           // 6: zond.eth.v1.ProposerDutiesRequest
	(*ProposerDutiesResponse)(nil),                                          // 7: zond.eth.v1.ProposerDutiesResponse
	(*ProposerDuty)(nil),                                                    // 8: zond.eth.v1.ProposerDuty
	(*ProduceBlockRequest)(nil),                                             // 9: zond.eth.v1.ProduceBlockRequest
	(*ProduceBlockResponse)(nil),                                            // 10: zond.eth.v1.ProduceBlockResponse
	(*ProduceAttestationDataRequest)(nil),                                   // 11: zond.eth.v1.ProduceAttestationDataRequest
	(*ProduceAttestationDataResponse)(nil),                                  // 12: zond.eth.v1.ProduceAttestationDataResponse
	(*AggregateAttestationRequest)(nil),                                     // 13: zond.eth.v1.AggregateAttestationRequest
	(*AggregateAttestationResponse)(nil),                                    // 14: zond.eth.v1.AggregateAttestationResponse
	(*SubmitAggregateAndProofsRequest)(nil),                                 // 15: zond.eth.v1.SubmitAggregateAndProofsRequest
	(*SubmitBeaconCommitteeSubscriptionsRequest)(nil),                       // 16: zond.eth.v1.SubmitBeaconCommitteeSubscriptionsRequest
	(*BeaconCommitteeSubscribe)(nil),                                        // 17: zond.eth.v1.BeaconCommitteeSubscribe
	(*PrepareBeaconProposerRequest)(nil),                                    // 18: zond.eth.v1.PrepareBeaconProposerRequest
	(*SubmitValidatorRegistrationsRequest)(nil),                             // 19: zond.eth.v1.SubmitValidatorRegistrationsRequest
	(*PrepareBeaconProposerRequest_FeeRecipientContainer)(nil),              // 20: zond.eth.v1.PrepareBeaconProposerRequest.FeeRecipientContainer
	(*SubmitValidatorRegistrationsRequest_ValidatorRegistration)(nil),       // 21: zond.eth.v1.SubmitValidatorRegistrationsRequest.ValidatorRegistration
	(*SubmitValidatorRegistrationsRequest_SignedValidatorRegistration)(nil), // 22: zond.eth.v1.SubmitValidatorRegistrationsRequest.SignedValidatorRegistration
	(*BeaconBlock)(nil),                                                     // 23: zond.eth.v1.BeaconBlock
	(*AttestationData)(nil),                                                 // 24: zond.eth.v1.AttestationData
	(*Attestation)(nil),                                                     // 25: zond.eth.v1.Attestation
	(*SignedAggregateAttestationAndProof)(nil),                              // 26: zond.eth.v1.SignedAggregateAttestationAndProof
}
var file_proto_eth_v1_validator_proto_depIdxs = []int32{
	0,  // 0: zond.eth.v1.ValidatorContainer.status:type_name -> zond.eth.v1.ValidatorStatus
	2,  // 1: zond.eth.v1.ValidatorContainer.validator:type_name -> zond.eth.v1.Validator
	5,  // 2: zond.eth.v1.AttesterDutiesResponse.data:type_name -> zond.eth.v1.AttesterDuty
	8,  // 3: zond.eth.v1.ProposerDutiesResponse.data:type_name -> zond.eth.v1.ProposerDuty
	23, // 4: zond.eth.v1.ProduceBlockResponse.data:type_name -> zond.eth.v1.BeaconBlock
	24, // 5: zond.eth.v1.ProduceAttestationDataResponse.data:type_name -> zond.eth.v1.AttestationData
	25, // 6: zond.eth.v1.AggregateAttestationResponse.data:type_name -> zond.eth.v1.Attestation
	26, // 7: zond.eth.v1.SubmitAggregateAndProofsRequest.data:type_name -> zond.eth.v1.SignedAggregateAttestationAndProof
	17, // 8: zond.eth.v1.SubmitBeaconCommitteeSubscriptionsRequest.data:type_name -> zond.eth.v1.BeaconCommitteeSubscribe
	20, // 9: zond.eth.v1.PrepareBeaconProposerRequest.recipients:type_name -> zond.eth.v1.PrepareBeaconProposerRequest.FeeRecipientContainer
	22, // 10: zond.eth.v1.SubmitValidatorRegistrationsRequest.registrations:type_name -> zond.eth.v1.SubmitValidatorRegistrationsRequest.SignedValidatorRegistration
	21, // 11: zond.eth.v1.SubmitValidatorRegistrationsRequest.SignedValidatorRegistration.message:type_name -> zond.eth.v1.SubmitValidatorRegistrationsRequest.ValidatorRegistration
