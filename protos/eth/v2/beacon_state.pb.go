...
// 	protoc        v3.15.8
// source: protos/eth/v2/beacon_state.proto
...
var file_proto_eth_v2_beacon_state_proto_goTypes = []interface{}{
	(*BeaconState)(nil),                // 0: zond.eth.v2.BeaconState
	(*BeaconStateBellatrix)(nil),       // 1: zond.eth.v2.BeaconStateBellatrix
	(*BeaconStateRequestV2)(nil),       // 2: zond.eth.v2.BeaconStateRequestV2
	(*BeaconStateResponseV2)(nil),      // 3: zond.eth.v2.BeaconStateResponseV2
	(*BeaconStateSSZResponseV2)(nil),   // 4: zond.eth.v2.BeaconStateSSZResponseV2
	(*BeaconStateContainer)(nil),       // 5: zond.eth.v2.BeaconStateContainer
	(*ForkChoiceHeadsResponse)(nil),    // 6: zond.eth.v2.ForkChoiceHeadsResponse
	(*ForkChoiceHead)(nil),             // 7: zond.eth.v2.ForkChoiceHead
	(*v1.Fork)(nil),                    // 8: zond.eth.v1.Fork
	(*v1.BeaconBlockHeader)(nil),       // 9: zond.eth.v1.BeaconBlockHeader
	(*v1.Eth1Data)(nil),                // 10: zond.eth.v1.Eth1Data
	(*v1.Validator)(nil),               // 11: zond.eth.v1.Validator
	(*v1.Checkpoint)(nil),              // 12: zond.eth.v1.Checkpoint
	(*SyncCommittee)(nil),              // 13: zond.eth.v2.SyncCommittee
	(*v11.ExecutionPayloadHeader)(nil), // 14: ethereum.engine.v1.ExecutionPayloadHeader
	(Version)(0),                       // 15: zond.eth.v2.Version
	(*v1.BeaconState)(nil),             // 16: zond.eth.v1.BeaconState
}
var file_proto_eth_v2_beacon_state_proto_depIdxs = []int32{
	8,  // 0: zond.eth.v2.BeaconState.fork:type_name -> zond.eth.v1.Fork
	9,  // 1: zond.eth.v2.BeaconState.latest_block_header:type_name -> zond.eth.v1.BeaconBlockHeader
	10, // 2: zond.eth.v2.BeaconState.eth1_data:type_name -> zond.eth.v1.Eth1Data
	10, // 3: zond.eth.v2.BeaconState.eth1_data_votes:type_name -> zond.eth.v1.Eth1Data
	11, // 4: zond.eth.v2.BeaconState.validators:type_name -> zond.eth.v1.Validator
	12, // 5: zond.eth.v2.BeaconState.previous_justified_checkpoint:type_name -> zond.eth.v1.Checkpoint
	12, // 6: zond.eth.v2.BeaconState.current_justified_checkpoint:type_name -> zond.eth.v1.Checkpoint
	12, // 7: zond.eth.v2.BeaconState.finalized_checkpoint:type_name -> zond.eth.v1.Checkpoint
	13, // 8: zond.eth.v2.BeaconState.current_sync_committee:type_name -> zond.eth.v2.SyncCommittee
	13, // 9: zond.eth.v2.BeaconState.next_sync_committee:type_name -> zond.eth.v2.SyncCommittee
	8,  // 10: zond.eth.v2.BeaconStateBellatrix.fork:type_name -> zond.eth.v1.Fork
	9,  // 11: zond.eth.v2.BeaconStateBellatrix.latest_block_header:type_name -> zond.eth.v1.BeaconBlockHeader
	10, // 12: zond.eth.v2.BeaconStateBellatrix.eth1_data:type_name -> zond.eth.v1.Eth1Data
	10, // 13: zond.eth.v2.BeaconStateBellatrix.eth1_data_votes:type_name -> zond.eth.v1.Eth1Data
	11, // 14: zond.eth.v2.BeaconStateBellatrix.validators:type_name -> zond.eth.v1.Validator
	12, // 15: zond.eth.v2.BeaconStateBellatrix.previous_justified_checkpoint:type_name -> zond.eth.v1.Checkpoint
	12, // 16: zond.eth.v2.BeaconStateBellatrix.current_justified_checkpoint:type_name -> zond.eth.v1.Checkpoint
	12, // 17: zond.eth.v2.BeaconStateBellatrix.finalized_checkpoint:type_name -> zond.eth.v1.Checkpoint
	13, // 18: zond.eth.v2.BeaconStateBellatrix.current_sync_committee:type_name -> zond.eth.v2.SyncCommittee
	13, // 19: zond.eth.v2.BeaconStateBellatrix.next_sync_committee:type_name -> zond.eth.v2.SyncCommittee
	14, // 20: zond.eth.v2.BeaconStateBellatrix.latest_execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader
	15, // 21: zond.eth.v2.BeaconStateResponseV2.version:type_name -> zond.eth.v2.Version
	5,  // 22: zond.eth.v2.BeaconStateResponseV2.data:type_name -> zond.eth.v2.BeaconStateContainer
	15, // 23: zond.eth.v2.BeaconStateSSZResponseV2.version:type_name -> zond.eth.v2.Version
	16, // 24: zond.eth.v2.BeaconStateContainer.phase0_state:type_name -> zond.eth.v1.BeaconState
	0,  // 25: zond.eth.v2.BeaconStateContainer.altair_state:type_name -> zond.eth.v2.BeaconState
	1,  // 26: zond.eth.v2.BeaconStateContainer.bellatrix_state:type_name -> zond.eth.v2.BeaconStateBellatrix
	7,  // 27: zond.eth.v2.ForkChoiceHeadsResponse.data:type_name -> zond.eth.v2.ForkChoiceHead
