...
// 	protoc        v3.15.8
// source: protos/eth/v2/ssz.proto
...
var file_proto_eth_v2_ssz_proto_goTypes = []interface{}{
	(*SSZContainer)(nil), // 0: zond.eth.v2.SSZContainer
	(Version)(0),         // 1: zond.eth.v2.Version
}
var file_proto_eth_v2_ssz_proto_depIdxs = []int32{
	1, // 0: zond.eth.v2.SSZContainer.version:type_name -> zond.eth.v2.Version
