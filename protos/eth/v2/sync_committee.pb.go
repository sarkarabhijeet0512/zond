...
// 	protoc        v3.15.8
// source: protos/eth/v2/sync_committee.proto
...
type SyncCommitteeValidators struct {
	...
	Validators          []github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,rep,packed,name=validators,proto3" json:"validators,omitempty" cast-type:"github.com/theQRL/zond/consensus-types/primitives.ValidatorIndex"`
...
var file_proto_eth_v2_sync_committee_proto_rawDesc = []byte{
	...
	0x88, 0x01, 0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x22, 0x8e, 0x01,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x4f, 0x70, 0x74, 0x69, 0x6d, 0x69, 0x73, 0x74, 0x69, 0x63, 0x22, 0xea,
	0x01, 0x0a, 0x17, 0x53, 0x79, 0x6e, 0x63, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x65,
	0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x12, 0x6f, 0x0a, 0x0a, 0x76, 0x61,
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x04, 0x42, 0x4f,
	...
	0x0a, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x12, 0x5e, 0x0a, 0x14, 0x76,
	0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x5f, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61,
	0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x65, 0x74, 0x68, 0x65,
	...
	0x72, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x73, 0x22, 0x8d, 0x01, 0x0a, 0x1a,
	...
	0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x70, 0x72, 0x69, 0x6d, 0x69, 0x74, 0x69, 0x76, 0x65, 0x73,
	0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52,
	0x0a, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x42, 0x83, 0x01, 0x0a, 0x13,
...
var file_proto_eth_v2_sync_committee_proto_goTypes = []interface{}{
	(*SubmitSyncCommitteeSignaturesRequest)(nil), // 0: zond.eth.v2.SubmitSyncCommitteeSignaturesRequest
	(*SyncCommittee)(nil),                        // 1: zond.eth.v2.SyncCommittee
	(*SubmitPoolSyncCommitteeSignatures)(nil),    // 2: zond.eth.v2.SubmitPoolSyncCommitteeSignatures
	(*SyncCommitteeMessage)(nil),                 // 3: zond.eth.v2.SyncCommitteeMessage
	(*StateSyncCommitteesRequest)(nil),           // 4: zond.eth.v2.StateSyncCommitteesRequest
	(*StateSyncCommitteesResponse)(nil),          // 5: zond.eth.v2.StateSyncCommitteesResponse
	(*SyncCommitteeValidators)(nil),              // 6: zond.eth.v2.SyncCommitteeValidators
	(*SyncSubcommitteeValidators)(nil),           // 7: zond.eth.v2.SyncSubcommitteeValidators
}
var file_proto_eth_v2_sync_committee_proto_depIdxs = []int32{
	3, // 0: zond.eth.v2.SubmitSyncCommitteeSignaturesRequest.data:type_name -> zond.eth.v2.SyncCommitteeMessage
	3, // 1: zond.eth.v2.SubmitPoolSyncCommitteeSignatures.data:type_name -> zond.eth.v2.SyncCommitteeMessage
	6, // 2: zond.eth.v2.StateSyncCommitteesResponse.data:type_name -> zond.eth.v2.SyncCommitteeValidators
	7, // 3: zond.eth.v2.SyncCommitteeValidators.validator_aggregates:type_name -> zond.eth.v2.SyncSubcommitteeValidators
