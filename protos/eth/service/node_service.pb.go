...
// 	protoc        v3.15.8
// source: protos/eth/service/node_service.proto
...
var file_proto_eth_service_node_service_proto_goTypes = []interface{}{
	...
	(*v1.PeersRequest)(nil),      // 1: zond.eth.v1.PeersRequest
	(*v1.PeerRequest)(nil),       // 2: zond.eth.v1.PeerRequest
	(*v1.IdentityResponse)(nil),  // 3: zond.eth.v1.IdentityResponse
	(*v1.PeersResponse)(nil),     // 4: zond.eth.v1.PeersResponse
	(*v1.PeerResponse)(nil),      // 5: zond.eth.v1.PeerResponse
	(*v1.PeerCountResponse)(nil), // 6: zond.eth.v1.PeerCountResponse
	(*v1.SyncingResponse)(nil),   // 7: zond.eth.v1.SyncingResponse
	(*v1.VersionResponse)(nil),   // 8: zond.eth.v1.VersionResponse
}
var file_proto_eth_service_node_service_proto_depIdxs = []int32{
	0, // 0: zond.eth.service.BeaconNode.GetIdentity:input_type -> google.protobuf.Empty
	1, // 1: zond.eth.service.BeaconNode.ListPeers:input_type -> zond.eth.v1.PeersRequest
	2, // 2: zond.eth.service.BeaconNode.GetPeer:input_type -> zond.eth.v1.PeerRequest
	0, // 3: zond.eth.service.BeaconNode.PeerCount:input_type -> google.protobuf.Empty
	0, // 4: zond.eth.service.BeaconNode.GetSyncStatus:input_type -> google.protobuf.Empty
	0, // 5: zond.eth.service.BeaconNode.GetVersion:input_type -> google.protobuf.Empty
	0, // 6: zond.eth.service.BeaconNode.GetHealth:input_type -> google.protobuf.Empty
	3, // 7: zond.eth.service.BeaconNode.GetIdentity:output_type -> zond.eth.v1.IdentityResponse
	4, // 8: zond.eth.service.BeaconNode.ListPeers:output_type -> zond.eth.v1.PeersResponse
	5, // 9: zond.eth.service.BeaconNode.GetPeer:output_type -> zond.eth.v1.PeerResponse
	6, // 10: zond.eth.service.BeaconNode.PeerCount:output_type -> zond.eth.v1.PeerCountResponse
	7, // 11: zond.eth.service.BeaconNode.GetSyncStatus:output_type -> zond.eth.v1.SyncingResponse
	8, // 12: zond.eth.service.BeaconNode.GetVersion:output_type -> zond.eth.v1.VersionResponse
	0, // 13: zond.eth.service.BeaconNode.GetHealth:output_type -> google.protobuf.Empty
...
func (c *beaconNodeClient) GetIdentity(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*v1.IdentityResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zond.eth.service.BeaconNode/GetIdentity", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *beaconNodeClient) ListPeers(ctx context.Context, in *v1.PeersRequest, opts ...grpc.CallOption) (*v1.PeersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zond.eth.service.BeaconNode/ListPeers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *beaconNodeClient) GetPeer(ctx context.Context, in *v1.PeerRequest, opts ...grpc.CallOption) (*v1.PeerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zond.eth.service.BeaconNode/GetPeer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *beaconNodeClient) PeerCount(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*v1.PeerCountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zond.eth.service.BeaconNode/PeerCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *beaconNodeClient) GetSyncStatus(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*v1.SyncingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zond.eth.service.BeaconNode/GetSyncStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *beaconNodeClient) GetVersion(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*v1.VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zond.eth.service.BeaconNode/GetVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *beaconNodeClient) GetHealth(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/zond.eth.service.BeaconNode/GetHealth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BeaconNode_GetIdentity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zond.eth.service.BeaconNode/GetIdentity",
	}
...
func _BeaconNode_ListPeers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zond.eth.service.BeaconNode/ListPeers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BeaconNode_GetPeer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zond.eth.service.BeaconNode/GetPeer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BeaconNode_PeerCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zond.eth.service.BeaconNode/PeerCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BeaconNode_GetSyncStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zond.eth.service.BeaconNode/GetSyncStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BeaconNode_GetVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zond.eth.service.BeaconNode/GetVersion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BeaconNode_GetHealth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zond.eth.service.BeaconNode/GetHealth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _BeaconNode_serviceDesc = grpc.ServiceDesc{
	ServiceName: "zond.eth.service.BeaconNode",
	...
	Metadata: "protos/eth/service/node_service.proto",
}
