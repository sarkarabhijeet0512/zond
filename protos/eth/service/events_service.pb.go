...
// 	protoc        v3.15.8
// source: protos/eth/service/events_service.proto
...
var file_proto_eth_service_events_service_proto_goTypes = []interface{}{
	(*v1.StreamEventsRequest)(nil), // 0: zond.eth.v1.StreamEventsRequest
	(*gateway.EventSource)(nil),    // 1: gateway.EventSource
}
var file_proto_eth_service_events_service_proto_depIdxs = []int32{
	0, // 0: zond.eth.service.Events.StreamEvents:input_type -> zond.eth.v1.StreamEventsRequest
	1, // 1: zond.eth.service.Events.StreamEvents:output_type -> gateway.EventSource
...
func (c *eventsClient) StreamEvents(ctx context.Context, in *v1.StreamEventsRequest, opts ...grpc.CallOption) (Events_StreamEventsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Events_serviceDesc.Streams[0], "/zond.eth.service.Events/StreamEvents", opts...)
	if err != nil {
		return nil, err
	}
...
var _Events_serviceDesc = grpc.ServiceDesc{
	ServiceName: "zond.eth.service.Events",
	...
	Metadata: "protos/eth/service/events_service.proto",
}
