...
func execHeaderPath(slot types.Slot, parentHash [32]byte, pubkey [1472]byte) (string, error) {
	v := struct {
		Slot       types.Slot
		ParentHash string
		Pubkey     string
...
func (c *Client) GetHeader(ctx context.Context, slot types.Slot, parentHash [32]byte, pubkey [1472]byte) (*ethpb.SignedBuilderBid, error) {
