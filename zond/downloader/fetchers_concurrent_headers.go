...
func (q *headerQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *zond.Response) (*zond.Request, error) {
...
func (q *headerQueue) deliver(peer *peerConnection, packet *zond.Response) (int, error) {
	headers := *packet.Res.(*zond.BlockHeadersPacket)
