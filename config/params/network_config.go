...
type NetworkConfig struct {
	...
	// DiscoveryV5 Config
	ETH2Key                    string // ETH2Key is the ZNR key of the Ethereum consensus object in an znr.
	AttSubnetKey               string // AttSubnetKey is the ZNR key of the subnet bitfield in the znr.
	SyncCommsSubnetKey         string // SyncCommsSubnetKey is the ZNR key of the sync committee subnet bitfield in the znr.
