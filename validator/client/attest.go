...
func (v *validator) SubmitAttestation(ctx context.Context, slot types.Slot, pubKey [dilithium.PKSizePacked]byte) {
...
func (v *validator) duty(pubKey [dilithium.PKSizePacked]byte) (*ethpb.DutiesResponse_Duty, error) {
	if v.duties == nil {
...
func (v *validator) signAtt(ctx context.Context, pubKey [dilithium.PKSizePacked]byte, data *ethpb.AttestationData, slot types.Slot) ([]byte, [32]byte, error) {
...
func attestationLogFields(pubKey [dilithium.PKSizePacked]byte, indexedAtt *ethpb.IndexedAttestation) logrus.Fields {
