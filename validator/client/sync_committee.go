...
func (v *validator) SubmitSyncCommitteeMessage(ctx context.Context, slot types.Slot, pubKey [dilithium.PKSizePacked]byte) {
...
func (v *validator) SubmitSignedContributionAndProof(ctx context.Context, slot types.Slot, pubKey [dilithium.PKSizePacked]byte) {
...
func (v *validator) selectionProofs(ctx context.Context, slot types.Slot, pubKey [dilithium.PKSizePacked]byte, indexRes *ethpb.SyncSubcommitteeIndexResponse) ([][]byte, error) {
...
func (v *validator) signSyncSelectionData(ctx context.Context, pubKey [dilithium.PKSizePacked]byte, index uint64, slot types.Slot) (signature []byte, err error) {
...
func (v *validator) signContributionAndProof(ctx context.Context, pubKey [dilithium.PKSizePacked]byte, c *ethpb.ContributionAndProof, slot types.Slot) ([]byte, error) {
