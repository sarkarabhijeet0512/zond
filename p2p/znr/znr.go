...
func (r *Record) Set(e Entry) {
	...
	if err != nil {
		panic(fmt.Errorf("znr: can't encode %s: %v", e.ZNRKey(), err))
	}
	r.invalidate()
...
func (r *Record) SetSig(s IdentityScheme, sig []byte) error {
	...
	case s == nil && sig != nil:
		panic("znr: invalid call to SetSig with non-nil signature but nil scheme")
	case s != nil && sig == nil:
		panic("znr: invalid call to SetSig with nil signature but non-nil scheme")
