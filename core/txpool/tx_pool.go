...
import (
	...
	"github.com/theQRL/zond/consensus/misc"
...
func (pool *TxPool) validateTx(tx *types.Transaction, local bool) error {
	...
	// data, err := proto.Marshal(tx.PbTx)
	// if err != nil {
	// 	return err
	// }
	// fmt.Println(uint64(len(data)))
	// fmt.Println(txMaxSize)
	...
	// fmt.Println("gas", tx.PbTx.GetGas())
	// fmt.Println("intrGas", intrGas)
	if tx.Gas() < intrGas {
...
func (pool *TxPool) add(tx *types.Transaction, local bool) (replaced bool, err error) {
	...
	replaced, err = pool.enqueueTx(tx.Hash(), tx, isLocal, true)
	if err != nil {
		return false, err
	}
