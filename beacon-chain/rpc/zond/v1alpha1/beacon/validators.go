...
import (
	...
	"github.com/theQRL/zond/api/pagination"
	...
	"github.com/theQRL/zond/beacon-chain/core/validators"
...
func (bs *Server) GetValidator(
	...
	pk48 := bytesutil.ToBytes1472Dilthium(pubKey)
...
func (bs *Server) GetIndividualVotes(
	...
	for _, pubKey := range req.PublicKeys {
		index, ok := st.ValidatorIndexByPubkey(bytesutil.ToBytes1472Dilthium(pubKey))
		if !ok {
